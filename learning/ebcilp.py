    ...
    def train(self):
        ...
        while True:
            ...
            if x is not None:
                ...
                c_grad  =  self.conf.alpha*gen_w_grad  + self.conf.beta*dis_w_grad
                ...
                trn_acc_gen,trn_acc_dis = self.evaluate(trn_dat,trn_inds)
        ...
        vld_acc_gen,vld_acc_dis = self.evaluate(vld_dat,vld_inds)
